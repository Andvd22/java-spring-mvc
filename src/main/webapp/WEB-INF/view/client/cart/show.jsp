                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach var="cartDetail" items="${cartDetails}">
                                ...
                                <td>
                                    <p class="mb-0 mt-4">
                                        <a href="/product/${cartDetail.product.id}" target="blank">${cartDetail.product.name}</a>                                      
                                    </p>
                                </td>
                                    <p class="mb-0 mt-4">
                                <td>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">
                                    <fmt:formatNumber type="number" value="${cartDetail.product.price * cartDetail.quantity}"/> 
                                    </p>
                                </td>
                                <td>
                        ...
                        <div class="bg-light rounded">
                            <div class="p-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <p class="mb-0"> <fmt:formatNumber value="${totalPrice}" type="number"/>đ</p>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-0 me-4">Phí vận chuyển</h5>
                                    <div class="">
                                        <p class="mb-0">Flat rate: 3000đ</p>
                                    </div>
                                </div>
                            ...
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                ...
                                <p class="mb-0 pe-4"><fmt:formatNumber value="${totalPrice + 3000}" type="number"/>đ</p>
                            </div>
